...
**Latest Update:** Merged (PR #348) and deployed to staging 2026-03-04. CI run 22675945514 — Quality Checks ✅ (1m30s) + Deploy to Staging ✅ (5m7s). Ready for Joao to test on staging.
**Severity:** High
**Size:** S
**Type:** Bug Fix
**Depends On:** —
